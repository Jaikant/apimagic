...
This guide shows you exactly how to set up **Playwright with Chromium** to run globally on your MacBook **and** work inside **Claude Code** via the Playwright MCP server. You'll avoid duplicate browser downloads and get a working automation setup.
